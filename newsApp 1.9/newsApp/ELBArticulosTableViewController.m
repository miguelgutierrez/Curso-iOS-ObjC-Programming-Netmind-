...
-(void)muestraCantidadDeLecturas
{
    ...
    // NSString *lecturasStr= [NSString stringWithFormat:@"Has realizado %i lecturas",_lecturasRealizadas];
    
    NSString *lecturasStr= [NSString stringWithFormat:NSLocalizedString(@"LecturasRealizadas", @"") ,_lecturasRealizadas];
