...
-(void)enviarMail
{
    ...
    if (mailComposer) {
        ...
        NSString*asunto=[NSString stringWithFormat:NSLocalizedString(@"AsuntoMail", nil), _articulo.nombre];
        NSString *texto= [NSString stringWithFormat:NSLocalizedString(@"TextoMail", nil),
                          _articulo.nombre,
                          _articulo.fecha,
                          _articulo.texto];
...
-(void)compartirTwitter
{
    ...
    {
        NSString *texto= [NSString stringWithFormat:NSLocalizedString(@"TextoTwitter", nil),
                          _articulo.nombre];
