...
- (IBAction)setTrasparencia:(id)sender
{
    ...
    [_portadaImageView setAlpha:((UIStepper*)sender).value];
    
}

/*
 pendiente controlar la action cuanto todavía se está ejecutando el animateWithDuration
 */
- (IBAction)setDuracionMovimiento:(id)sender {
    ...
    NSTimeInterval tiempoDuracion= ((UISlider*)sender).value;
