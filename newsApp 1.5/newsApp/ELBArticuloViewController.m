...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    // o [self ocultarTeclado:nil];
}

- (IBAction)ocultarTeclado:(id)sender
{
    
    [_nombreEscritorTextField resignFirstResponder];
    [_fechaArticuloTextField resignFirstResponder];
    [_textoArticuloTextView resignFirstResponder];
